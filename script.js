...
// ======================= 星露谷角色数据 =======================
const CHARACTERS = [
    { name: "Abigail",   tags: [7, 9, 5, 4, 8, 7] },
    { name: "Alex",      tags: [9, 4, 6, 8, 3, 5] },
    { name: "Elliott",   tags: [5, 8, 8, 5, 7, 9] },
    { name: "Emily",     tags: [6, 7, 9, 6, 9, 7] },
    { name: "Haley",     tags: [8, 3, 4, 3, 2, 6] },
    { name: "Harvey",    tags: [3, 6, 8, 9, 5, 5] },
    { name: "Leah",      tags: [4, 7, 7, 7, 9, 8] },
    { name: "Maru",      tags: [5, 9, 7, 9, 5, 4] },
    { name: "Penny",     tags: [3, 6, 9, 7, 6, 7] },
    { name: "Sam",       tags: [8, 7, 6, 5, 4, 6] },
    { name: "Sebastian", tags: [2, 8, 5, 6, 7, 5] },
    { name: "Shane",     tags: [2, 3, 7, 2, 4, 3] }
];
